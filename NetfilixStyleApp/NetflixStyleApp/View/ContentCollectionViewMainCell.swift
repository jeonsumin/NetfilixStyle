...
//  NetfilixStyleApp
//
//  Created by Terry on 2022/01/18.
//
...
class ContentCollectionViewMainCell :UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        [imageView,descriptionLabal, contentStackView].forEach {
        ...
        //discriptionLabel
        descriptionLabal.font = .systemFont(ofSize: 13)
        descriptionLabal.textColor = .white
        descriptionLabal.sizeToFit()
